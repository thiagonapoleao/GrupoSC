...
var ConferenciaPageModule = /** @class */ (function () {
    function ConferenciaPageModule() {
    }
...
var ConferenciaPage = /** @class */ (function () {
    function ConferenciaPage(navCtrl, service, route) {
        this.navCtrl = navCtrl;
        this.service = service;
        this.route = route;
        this.getDados();
    }
    ConferenciaPage.prototype.getDados = function () {
        var _this = this;
        this.service.getAlluser().then(function (result) {
            _this.analises = result['analises'];
            console.log(_this.analises);
        }).catch(function (error) {
            console.error("error: " + error);
        });
    };
    ConferenciaPage.prototype.ngOnInit = function () {
    };
    ConferenciaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-conferencia-conferencia-module-es5.js.map