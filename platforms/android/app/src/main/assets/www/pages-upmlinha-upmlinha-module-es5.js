...
var UpmlinhaPage = /** @class */ (function () {
    function UpmlinhaPage(navCtrl, service, route) {
    ...
    UpmlinhaPage.prototype.buscaDados = function () {
        this.getDados();
        this.getDadosUpm();
        this.getDadosEstacao();
    };
    UpmlinhaPage.prototype.getDados = function () {
        var _this = this;
    ...
    UpmlinhaPage.prototype.getDadosUpm = function () {
        var _this = this;
    ...
    UpmlinhaPage.prototype.getDadosEstacao = function () {
        var _this = this;
    ...
    UpmlinhaPage.prototype.ngAfterViewInit = function () {
    };
    UpmlinhaPage.prototype.getChart = function (context, chartType, data, options) {
    ...
    UpmlinhaPage.prototype.getBarChart = function () {
        //console.log(this.upmh);
        type: 'bar';
        var rotulos = [];
        var dados = [];
    ...
    UpmlinhaPage.prototype.getBarChart2 = function () {
        //console.log(this.upmh);
        type: 'bar';
        var rotulos = [];
        var dados = [];
    ...
    UpmlinhaPage.prototype.getBarChart3 = function () {
        //console.log(this.upmh);
        type: 'bar';
        var rotulos = [];
        var dados = [];
    ...
    UpmlinhaPage.ctorParameters = function () { return [
