...
var FechamentoPageModule = /** @class */ (function () {
    function FechamentoPageModule() {
    }
...
var FechamentoPage = /** @class */ (function () {
    function FechamentoPage(navCtrl, service, route) {
        this.navCtrl = navCtrl;
        this.service = service;
        this.route = route;
    }
    FechamentoPage.prototype.ngOnInit = function () {
    };
    FechamentoPage.prototype.Fechamento = function () {
        var _this = this;
    ...
    FechamentoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-fechamento-fechamento-module-es5.js.map