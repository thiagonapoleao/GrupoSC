...
var map = {
	"./pages/analiseprodconf/analiseprodconf.module": [
...
/* harmony import */ var _app_pages_services_dados_sc_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../app/pages/services/dados-sc.service */ "./src/app/pages/services/dados-sc.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _app_pages_services_dados_sc_service__WEBPACK_IMPORTED_MODULE_11__["DadosSCService"]
            ],
...
/***/ "./src/app/pages/services/dados-sc.service.ts":
/*!****************************************************!*\
  !*** ./src/app/pages/services/dados-sc.service.ts ***!
  \****************************************************/
/*! exports provided: DadosSCService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DadosSCService", function() { return DadosSCService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DadosSCService = /** @class */ (function () {
    // url: string = "http://localhost/phpp/";
    function DadosSCService(http) {
        this.http = http;
    ...
    DadosSCService.prototype.getFechamento = function (data, total, comercial, linha, psico, pgunidades, pgvolumes, inciolinha, faltalinha, conferido, faltaconferir, tlinha, tconferencia, v762, v766, v790) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            _this.http.post('http://localhost/phpp/api-fechamento.php', myData, options)
                .toPromise()
    ...
    DadosSCService.prototype.getUpmhr = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            // let url = 'http://172.20.10.6/phpp/upm.php'; //laravel
            var url = 'http://localhost/phpp/api-upmhora.php'; //laravel
            _this.http.get(url)
                .toPromise()
                .then(function (result) {
                resolve(result.json());
    ...
    DadosSCService.prototype.getEstacao = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            // let url = 'http://172.20.10.6/phpp/upm.php'; //laravel
            var url = 'http://localhost/phpp/api-upmestacao.php'; //laravel
            _this.http.get(url)
                .toPromise()
                .then(function (result) {
                resolve(result.json());
    ...
    DadosSCService.ctorParameters = function () { return [
        { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
    ]; };
    DadosSCService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"]])
    ], DadosSCService);
    return DadosSCService;
}());
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyCLn2emHm7d5lUdVwC9NjKUH6ZSUMWgs9U",
        authDomain: "gruposc-7c684.firebaseapp.com",
        databaseURL: "https://gruposc-7c684.firebaseio.com",
        projectId: "gruposc-7c684",
        storageBucket: "",
        messagingSenderId: "937318623660",
        appId: "1:937318623660:web:8dc70c4b226daebd"
    }
};
/*
 ...
 */
// import 'zone.js/dist/zone-error';  //h Included with Angular CLI.
...
module.exports = __webpack_require__(/*! C:\Desenvolvimento\TCC\V00\GrupoSC\src\main.ts */"./src/main.ts");
