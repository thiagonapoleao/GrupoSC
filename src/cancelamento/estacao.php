...
<body
    ...
    <div class="container" id="cabecalho" style=" color: whitesmoke; width: 500px; margin-top: 1%; ">
        <div class="border border-primary" style="border-radius: 5mm;">
            <form action="consultaestacao.php" method="post">
                <div class="container" align="center">
                    <div class="container"> 
                        <br>
                        <div class="col-md-8" style="text-align: center;">
                            <label>Informe o Estação</label>
                            <input style="text-align: center;" class="form-control" type="text" name="estacao" id="estacao"
                                placeholder="Estação" autofocus autocomplete="off" readonly
