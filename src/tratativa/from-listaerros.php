...
// SQL para selecionar os registros
$sql_arry_falta = "SELECT SUM(falta_upm) FROM pln0098r WHERE data <> ''";
// seleciona os registros
...
// SQL para selecionar os registros
$sql_arry_sobra = "SELECT SUM(sobra_upm) FROM pln0098r WHERE data <> ''";
// seleciona os registros
...
// SQL para selecionar os registros
$sql_arry_troca = "SELECT SUM(troca_upm) FROM pln0098r WHERE data <> ''";
// seleciona os registros
...
// SQL para selecionar os registros
$sql_arry_conf = "SELECT SUM(erro_conf_upm) FROM pln0098r WHERE data <> ''";
// seleciona os registros
...
<body style="background-image:  url('../img/TelanovaGrupoSC.png'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; ">
    ...
    <div class="container" align="center" style="min-height: 500px;">
        <div class="border border-danger" style="background-color: white; color: black; width: 70%; border-radius: 20px; margin-top: 80px; font-size: 12px;">
            <from>
                <div class="border border-danger" style="background-color: white; color: black; width: 60%; border-radius: 20px; margin-top: 20px; font-size: 12px;">
                    ...
                    <div class="form-row" style="font-size: 14px; margin-top: -3px" id="total-div1">
                        <div id="metaTotal" class="col-sm-3 mb-1">
                            <label for="validationServer02" style="font-size: 16px;"><b>5.000</b></label>
                        </div>
                    ...
                    <table width="90%" align="center">
                        <thead>
                            <tr style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                <th scope="col" colspan="2" style="text-align: center; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    Total de erros!</th>
                            ...
                            <?php while ($erros = $stmt_array->fetch(PDO::FETCH_ASSOC)) : ?>
                                <tr style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    ...
                                    <td style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                        <?php
                                        // SQL para selecionar os registros
                                        $sql_arry_separador = "SELECT  nome FROM separadores where codigo = $erros[cod]";
                                        // seleciona os registros
