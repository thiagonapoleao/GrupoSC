...
$sql_count = "SELECT SUM(rota) FROM comprovei";
...
// SQL para selecionar os registros
$sql_arry = "SELECT id, rota, comprovei, operador_comprovei FROM demonstrativo WHERE data = '$datacontabil' and comprovei IS NOT NULL  order by id DESC, rota DESC";
// seleciona os registros
...
<body
    style="background: linear-gradient(to top,#004e92, #000428, #000000); background-attachment: fixed; background-size: 100% 100%; color:white">
    <header>
        ...
        <div class="container" style="margin-top: 30px; color:white">
            <form action="cpd/comprovei/add.php" method="post" class="needs-validation" id="formSearch" novalidate>
                <div class="container">
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-md-2 mb-3" style="margin-right: -20px;">
                            ...
                            <input type="text" class="form-control" name="operador" id="operador" required>
                            <div class="valid-feedback">
                                .
                            </div>
                        </div>
        ...
        <div class="container" align="center" style="margin-top: 5px;">
            <div class="border border-danger"
                ...
                <?php if ($total > 0) : ?>
                <table width="70%" align="center" id="tbl" style="margin-top: 5px;">
                    <thead>
                        <tr>
                            <th align="center"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center"
                                style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                <?php echo $tratativa['comprovei'] ?></td>
                            <td align="center"
                                style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                <?php echo $tratativa['operador_comprovei'] ?></td>
                            <td align="center"
                                style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                <a href="cpd/comprovei/delete.php?id=<?php echo $tratativa['id'] ?>"
    ...
    <footer style=" text-align-last: center;">
        ...
        <p style="color: white; margin-top: 5px;">Copyright &copy; 2021 - (GI) Gestão Integrada - Developed By Thiago
            Cesar Napoleão</p>
    </footer>
