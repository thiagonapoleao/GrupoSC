...
<body
    ...
    <header>
                ...
                <div class="modal-dialog">
                    <div class="modal-content"
                        ...
                        <div class="modal-body">
                            <form action="analiseauditoria790.php" method="post" class="needs-validation"
            ...
            <form action="add.php" method="post" class="needs-validation" id="formSearch" novalidate>
                <div class="col-auto"
                    ...
                    <div class="col-md-6 mb-3" style="margin-top: -20px;">
                        <label align="center"
                            style="align-items: center;display: flex;flex-direction: row;justify-content: center;">Responsalvel pela auditoria:  <?php echo $_SESSION['nome'] ?></label>
                        <input style="text-align: center;" type="number" class="form-control" name="picklist" placeholder="Aguardando leitura do Picklist"
                            id="picklist" autofocus required>
                    </div>
                    <div class="col-auto">
        ...
        <div class="container" align="center" style="margin-top: 3px; color: whitesmoke; ">
            <button type="button" class="btn btn-primary"><a data-toggle="modal" data-target="#meuModal">Importar
                    arquivo </a> </button>
