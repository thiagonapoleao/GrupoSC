...
// SQL para selecionar os registros
$sql_arry_auditoria = "SELECT picklist, count(DISTINCT volume), rota, roteiro FROM auditoria  where picklist = '$picklist' GROUP BY picklist order by picklist DESC";
// seleciona os registros
...
<body
    ...
    <header>
            ...
            <div id="collapse-navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="../grandesredes.php">Rota 790</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="container" align="center" style="margin-top: 10px;">
            ...
            <br>
            <div class="border border-danger"
                style="background-color: white; color: black; width: 80%; border-radius: 20px; font-size: 12px; min-height: 50px; margin-top: -10px;">
                    ...
                    <table align="center" id="tbl" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center"
                                    style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    <?php echo $faltadevolume['picklist'] ?>
                                </td>
                                <td align="center"
                                    style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    <?php echo $faltadevolume['volumeinicial'] ?>
                                </td>
                                <td align="center"
                                    style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    <?php echo $faltadevolume['volumefinal'] ?>
                                </td>
                                <td align="center"
                                    style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    <?php echo $faltadevolume['faltadvolume'] ?>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
