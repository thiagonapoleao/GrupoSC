...
$sql_arry = "SELECT DISTINCT picklist, volume, descricao, lote, validade, qtd, hora FROM auditoria order by picklist and volume desc";
...
$sql_arry_auditoria = "SELECT picklist, count(DISTINCT volume), rota, roteiro, data, data_aud FROM auditoria GROUP BY picklist order by data desc, picklist DESC";
                ...
                <div class="container" id="div">
                    ...
                    <table align="center" id="tbl" width="100%">
                        <thead>
                            <tr  align="center">
                                ...
                                <th  align="center"
                                    ...
                                    <th  align="center"
                                    style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    Data do Faturamento</th>
                                <th  align="center"
                                    style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                                    Data da Auditoria</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php while ($auditoria = $stmt_array_auditoria->fetch(PDO::FETCH_ASSOC)) : ?>                            
                            ...
                            $isoDate = dateConvert($auditoria['data_aud'] );
                            ?>
