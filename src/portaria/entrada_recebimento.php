...
style="background-image:  url('../img/TelanovaGrupoSC.png'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; ">
    ...
    <div class="container" style="margin-top: 80px; color:blanchedalmond;  align-items: center; " >
        <div  class="container">
            <form action="addEntradaRecebimento.php" method="post" class="needs-validation" id="formSearch" novalidate>
                <div class="container">
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-sm-2 mb-3" style="margin-right: -20px;">
                                ...
                                <input type="time" class="form-control" name="horario" id="horario" autofocus required>
                                <div class="valid-feedback">
                                    .
                                </div>
                        </div>
                        ...
                        <div class="col-sm-2 mb-3" style="margin-right: -20px;">
                            ...
                            <input type="number" class="form-control" name="cpf2" id="cpf2" >
                            <div class="valid-feedback">
                                .
                            </div>
                        </div> 
                        <div class="col-sm-2 mb-3" style="margin-right: -20px;">
                            ...
                            <input type="text" class="form-control" name="ajudante" id="ajudante" >
                            <div class="valid-feedback">
                                .
                            </div>
                        </div>
