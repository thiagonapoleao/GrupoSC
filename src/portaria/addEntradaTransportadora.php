...
$PDOPORT = db_connect_port();
	...
	$sql = "INSERT INTO entradatransportadora(data, codigomotorista, nome, entrada, empresa, placa, obs, vigilante) VALUES(:data, :codigomotorista, :nome, :entrada, :empresa, :placa, :obs, :vigilante)";
	...
	if ($stmt->execute()) {
        header('Location: entrada_transportadora.php');
	} else {
		echo ("<script LANGUAGE='JavaScript'>
		window.alert('print_r($stmt->errorInfo());');
		window.location.href='entrada_transportadora.php';
		</script>");
