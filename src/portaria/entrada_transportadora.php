...
$sql_count = "SELECT count(data) FROM entradatransportadora where data =  '$isoToday'";
...
// SQL para selecionar os registros
$sql_arry_4 = "SELECT id, data, codigomotorista, nome, placa, entrada, empresa, obs, vigilante FROM entradatransportadora where data = '$isoToday' order by entrada desc ";
// seleciona os registros
...
style="background-image:  url('../img/TelanovaGrupoSC.png'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; ">
    ...
    <div  style="margin-top: -15px">
        ...
        <div  class="container">
            <form action="addEntradaTransportadora.php" method="post" class="needs-validation" id="formSearch" novalidate>
                <div class="container">
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-sm-2 mb-3" style="margin-right: -20px;">
                            ...
                            <input type="number" class="form-control" name="cdveiculo" id="cdveiculo" autofocus onblur="myFunction()" required>
                            <div class="valid-feedback">
                                .
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2 mb-3" style="margin-right: -20px;">
                            ...
                            <input type="text" class="form-control" name="vigilante" id="vigilante" required>
                            <div class="valid-feedback">
                                .
                            </div>
                        </div>
    ...
    <div class="container" align="center" style="margin-top: -40px;">
        <div class="border border-danger"
            ...
            <h3>Entrada de Transportadora / Motorista SC SPI</h3>
            <?php if ($total > 0) : ?>
            <table style="background-color: white; color: black; width: 90%; font-size:12px; margin-top: 5px; ">
                ...
                <tbody>
                    <?php while ($entrada_transportadora = $stmt_array_4->fetch(PDO::FETCH_ASSOC)) : ?>
                    <tr>
                        <td
                            ...
                            <?php echo $entrada_transportadora['data'] ?></td>
                        <td
                            ...
                            <?php echo $entrada_transportadora['nome'] ?></td>
                        <td
                            style="text-align: center; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <?php echo $entrada_transportadora['placa'] ?></td>
                        <td
                            style="text-align: center;  border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove; ">
                            <?php echo $entrada_transportadora['entrada'] ?></td>
                        <td
                            style="text-align: left; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <?php echo $entrada_transportadora['empresa'] ?></td>
                        <td
                            style="text-align: left; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <?php echo $entrada_transportadora['obs'] ?></td>
                        <td
                            style="text-align: left; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <?php echo $entrada_transportadora['vigilante'] ?></td>                      
                        <td
                            style="text-align: center; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <a href="deleteEntradaTransportadora.php?id=<?php echo $entrada_transportadora['id'] ?>"
