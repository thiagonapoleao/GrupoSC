...
$sql_count = "SELECT count(codigo) FROM motoristas";
...
$sql_arry = "SELECT id,codigo, cpf, moto, empresa FROM motoristas GROUP BY moto asc ";
...
<body
    ...
    <div class="container" 
        ...
        <div class="container" style="margin-top: 80px; color:blanchedalmond;  " >
            <form action="addMotorista.php" method="post" class="needs-validation" novalidate>
                <div class="container" align="center">
                    <div class="row justify-content-md-center">
                        <div class="col-sm-2 mb-1">
                            <label for="validationServer01">CPF (Só Numero)</label>
        ...
        <div class="border border-danger"
            ...
            <h3>Cadastro de Motorista SC SPI</h3>
            <?php if ($total > 0) : ?>
            <table style="background-color: white; color: black; width: 90%; font-size:12px; margin-top: 5px; ">
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td
                            style="border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <a href="deleteMotorista.php?id=<?php echo $cadastro['id'] ?>"
