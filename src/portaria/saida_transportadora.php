...
$sql_count = "SELECT count(data) FROM saida_transportadora where data =  '$isoToday'";
...
// SQL para selecionar os registros
$sql_arry_4 = "SELECT id, data, codigomotorista, nome, placa, saida, empresa, obs, vigilante FROM saida_transportadora where data = '$isoToday' order by saida desc ";
// seleciona os registros
...
style="background-image:  url('../img/TelanovaGrupoSC.png'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; ">
    ...
    <div  style="margin-top: -15px">
        ...
        <div  class="container">
            <form action="addSaidaTransportadora.php" method="post" class="needs-validation" id="formSearch" novalidate>
                <div class="container">
    ...
    <div class="container" align="center" style="margin-top: -40px;">
        <div class="border border-danger"
            ...
            <h3>Saída de Transportadora / MotoristaSC SPI</h3>
            <?php if ($total > 0) : ?>
            <table style="background-color: white; color: black; width: 90%; font-size:12px; margin-top: 5px; ">
                ...
                <tbody>
                    <?php while ($saida_transportadora = $stmt_array_4->fetch(PDO::FETCH_ASSOC)) : ?>
                    <tr>
                        <td
                            ...
                            <?php echo $saida_transportadora['data'] ?></td>
                        <td
                            ...
                            <?php echo $saida_transportadora['nome'] ?></td>
                        <td
                            style="text-align: center; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <?php echo $saida_transportadora['placa'] ?></td>
                        <td
                            style="text-align: center; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove; ">
                            <?php echo $saida_transportadora['saida'] ?></td>
                        <td
                            style="text-align: left; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <?php echo $saida_transportadora['empresa'] ?></td>
                        <td
                            style="text-align: left; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <?php echo $saida_transportadora['obs'] ?></td>
                        <td
                            style="text-align: left; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <?php echo $saida_transportadora['vigilante'] ?></td>                      
                        <td
                            style="text-align: center; border-top-style: groove;border-left-style: groove;border-right-style: groove;border-bottom-style: groove;">
                            <a href="deleteSaidaTransportadora.php?id=<?php echo $saida_transportadora['id'] ?>"
