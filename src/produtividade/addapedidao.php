...
// SQL para selecionar os registros
$sql_arry_0048 = "SELECT codigo, nome, qtd FROM pln0048r ";
// seleciona os registros
$stmt_array_0048 = $PDO->prepare($sql_arry_0048);
$stmt_array_0048->execute();

$convdatacontabil = dateConvert($datacontabil);

while ($analise = $stmt_array_0048->fetch(PDO::FETCH_ASSOC)) :
