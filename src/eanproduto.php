...
style="background: linear-gradient(to top,#004e92, #000428, #000000); background-attachment: fixed; background-size: 100% 100%; ">
    <header>
        ...
        <div class="container" style="margin-top: 40px; ">
            ...
            <br>
            <form action="recebimento/consultaean.php" method="post" class="needs-validation" id="formSearch"
                novalidate>
                <div class="col-auto"
                    ...
                    <div class="col-md-6 mb-3" style="margin-top: -20px;">
                        <label align="center"
                            style="align-items: center;display: flex;flex-direction: row;justify-content: center;">Código
                            EAN do Produto</label>
                        <input style="text-align: center;" type="number" class="form-control" name="ean" id="ean"
                            autofocus required>
                    </div>
                    <div class="col-auto">
            ...
            <div class="container"
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" name="pfat" id="pfat" required>
                </div>
                <div class="col-md-2 mb-3">
                    <label>Código SAP</label>
                    <input type="number" class="form-control" name="sap" id="sap" required>
                </div>
                <div class="col-md-2 mb-3">
            ...
            <div class="container"
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control" name="descricao" id="descricao" autofocus required>
                </div>
                <div class="col-md-2 mb-3">
                    <label>Quant. de Excessos</label>
                    <input type="text" class="form-control" name="excesso" id="excesso" required>
                </div>
                <div class="col-md-2 mb-3">
                    <label>Validade da vez</label>
                    <input type="text" class="form-control" name="validade" id="validade" required>
                </div>
            </div>
