...
style="background: linear-gradient(to top,#004e92, #000428, #000000); background-attachment: fixed; background-size: 100% 100%; ">
    <header>
        ...
        <div class="container" style="margin-top: 40px; ">
            ...
            <br>
            <form action="recebimento/consultacracha.php" method="post" class="needs-validation" id="formSearch"
                novalidate>
                <div class="col-auto"
                    ...
                    <div class="col-md-6 mb-3" style="margin-top: -20px;">
                        <label align="center"
                            style="align-items: center;display: flex;flex-direction: row;justify-content: center;">Passe
                            o Crachá na Leitora</label>
                        <input style="text-align: center;" type="number" class="form-control" name="cracha" id="cracha"
                            autofocus required>
