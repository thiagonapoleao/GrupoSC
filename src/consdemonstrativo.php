...
$dataconsula = isset($_POST['data1']) ? $_POST['data1'] : null;
...
if(empty($dataconsula)){
    $data = dateConvert("$datacontabil");
} else {
    $data = $dataconsula; 
    $array = explode("-", $dataconsula);
    $mes = $array[1];
    $ano = $array[0];
    $dia = $array[2];
    $concatena_data = $dia."/".$mes."/".$ano;
...
// sql_count para contar o total de registros
$sql_count_nota = "SELECT SUM(danfenormal) FROM demonstrativo where data = '$data'";
// conta o toal de registros
...
// sql_count para contar o total de registros
$sql_count_nota_epec = "SELECT SUM(danfeepec) FROM demonstrativo where data = '$data'";
// conta o toal de registros
...
// SQL para selecionar os registros
$sql_arry = "SELECT id, rota, meta_liberacao_nota, liberacaocpd, impressora, danfenormal, danfeepec, fim_impressao, tempo_impr, meta_saida, comprovei, operador FROM demonstrativo WHERE data = '$concatena_data' order by sequencia desc";
// seleciona os registros
...
// SQL para selecionar os registros
$sql_arry_compr  = "SELECT id, rota, horario, operador FROM comprovei WHERE data = '$data' order by id DESC, rota DESC";
// seleciona os registros
$stmt_array_compr  = $PDO->prepare($sql_arry_compr );
$stmt_array_compr ->execute();

// SQL para selecionar os registros
$sql_meta_compr  = "SELECT horario FROM comprovei WHERE data = '$data'";
// seleciona os registros
    ...
    <header>
        ...
        <div class="container" align="center" style="margin-top: 30px;">
            <div class="border border-danger"
                ...
                <form action="consdemonstrativo.php" method="post">
                    <div class="form-row" style="margin-left: 125px; margin-top: 30px;">
                        <div class="col-md-2 mb-2">
                            <input type="date" name="data1" id="data1" style="font-size: 12px;" class="form-control"
