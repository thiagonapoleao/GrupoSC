...
style="background: linear-gradient(to top,#004e92, #000428, #000000); background-attachment: fixed; background-size: 100% 100%; ">
    <header>
        ...
        <div class="container" style="margin-top: 40px; ">
            ...
            <br>
            <form action="quantidadeetiquetas.php" method="post" class="needs-validation" id="formSearch" novalidate>
                <div class="col-auto"
                    ...
                    <div class="col-md-6 mb-3" style="margin-top: -20px;">
                        <label align="center"
                            ...
                            a Validade do Produto</label>
                        <input style="text-align: center;" type="text" class="form-control" name="escrvalidade"
                            id="escrvalidade" autofocus required>
                    </div>
                    <div class="col-auto">
                ...
                <div class="container"
                    ...
                    <div class="col-md-2 mb-3">
                        <label for="validationServer02">Código PFAT</label>
                        <input type="text" class="form-control" name="pfat" id="pfat"
                            value="<?php echo $_SESSION['codigo'] ?>">
                    </div>
                    <div class="col-md-2 mb-3">
                        <label for="validationServer05">Código SAP</label>
                        <input type="number" class="form-control" name="sap" id="sap"
                            value="<?php echo $_SESSION['codigo_sap'] ?>">
                    </div>
                    <div class="col-md-2 mb-3">
                        <label for="validationServer06">Código de Barras</label>
                        <input type="text" class="form-control" name="barra" id="barra"
                            value="<?php echo $_SESSION['ean'] ?>">
                    </div>
                    <div class="col-md-2 mb-3">
                ...
                <div class="container"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="descricao" id="descricao"
                            value="<?php echo $_SESSION['descricao'] ?>">
                    </div>
                    <div class="col-md-2 mb-3">
                        <label for="validationServer06">Quant. de Excessos</label>
                        <input type="text" class="form-control" name="excesso" id="excesso"
                            value="<?php echo $_SESSION['excesso'] ?>">
                    </div>
                    <div class="col-md-2 mb-3">
                        <label for="validationServer06">Validade da vez</label>
                        <input type="text" class="form-control" name="validade" id="validade"
                            value="<?php echo $_SESSION['validade'] ?>">
                    </div>
                </div>
            </form>
