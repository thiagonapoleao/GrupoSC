...
function erro(){
    ...
    echo   ' <h1 align="center"  style="margin-top: -20px;  color: white;">Usúario sem acesso  a área CPD!</h1>';
    echo '<img  style="margin-left: 20%;  border-radius: 30px; height: 60%; width: 60%;" src="img/Error-404-1170x700.jpg" />';
